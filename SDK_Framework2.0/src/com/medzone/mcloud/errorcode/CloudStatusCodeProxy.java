...
public class CloudStatusCodeProxy extends StatusCodeProxy {
    ...
    protected boolean createIfNotExist(int type) {
        ...
        switch (type) {
            case TYPE_LOGIN_AND_REGISTER:
                getCodes().put(type, new LoginRigisterCode());
                return true;
            case TYPE_HOME:
                getCodes().put(type, new HomeCode());
                return true;
            case TYPE_GROUP:
                getCodes().put(type, new GroupCode());
                return true;
            case TYPE_MEASURE:
                getCodes().put(type, new MeasureCode());
                return true;
            case TYPE_SERVICE:
                getCodes().put(type, new ServiceCode());
                return true;
            case TYPE_SETTING:
                getCodes().put(type, new SettingCode());
                return true;
            case TYPE_CONTACT:
                getCodes().put(type, new ContactCode());
                return true;
            default:
                return super.createIfNotExist(type);
        }
    }
    ...
    public class LocalCode {
         ...
         * error code.
         */
        public static final int CODE_REQUEST_FAILED = CodeProxy.CODE_REQUEST_FAILED;

        public static final int CODE_SUCCESS = CodeProxy.CODE_SUCCESS;

        /**
         * 无
         */
        public static final int CODE_10000 = CodeProxy.CODE_10000;
        /**
         * 当前网络不可用,请检查网络设置
         */
        public static final int CODE_10001 = CodeProxy.CODE_10001;
        /**
         * 网络异常,请稍后再试
         */
        public static final int CODE_10002 = CodeProxy.CODE_10002;
        /**
         * 字数超过限制
         */
        public static final int CODE_10003 = CodeProxy.CODE_10003;
        /**
         * 没有找到储存卡
         */
        public static final int CODE_10004 = CodeProxy.CODE_10004;
        /**
         * 服务器异常，请稍后再试
         */
        public static final int CODE_10005 = CodeProxy.CODE_10005;
